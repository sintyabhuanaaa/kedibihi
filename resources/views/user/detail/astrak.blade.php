...
<body>
  ...
  <div class="product-detail">
    <img src="{{ asset('img/astrak.png') }}" alt="Sok Asi / Keben">
    <div class="product-info">
      <h2>ASTRAK</h2>
 <table>
  <tr>
    <td>Harga Produk</td>
    <td><strong>Rp350.000,00</strong></td>
  </tr>
  <tr>
    <td>Stock</td>
  ...
  <td>
    <a href="https://vt.tiktok.com/XXXXXXXXX/" target="_blank" style="color: #ff0050; font-weight: bold; text-decoration: none;">
      ...
      <div class="product-description">
        Produk astrak berbahan baku dari bambu yang dibuat dengan kualitas terbaik.
      </div>
    </div>
