...
<body>
  ...
  <div class="product-detail">
    <img src="{{ asset('img/tas.png') }}" alt="Sok Asi / Keben">
    <div class="product-info">
      <h2>TAS ANYAMAN</h2>
      <table>
        <tr><td>Harga Produk</td><td><strong>Rp150.000,00</strong></td></tr>
        <tr><td>Stock</td><td><strong>Tersedia</strong></td></tr>
        <tr><td>Provinsi</td><td><strong>Bali</strong></td></tr>
        <tr><td>Kota/Kabupaten</td><td><strong>Bangli</strong></td></tr>
        <tr>
      ...
      <div class="product-description">
        Produk tas berbahan baku dari bambu yang dibuat dengan kualitas terbaik.
      </div>
    </div>
  </div> <!-- penutup .product-detail -->
  ...
  <section class="ulasan-produk">
    ...
    <!-- Form Komentar -->
    <form class="form-ulasan" id="formUlasan">
